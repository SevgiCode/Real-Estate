...
if(isset($_POST['post'])){
   ...
   $property_price = filter_var($property_price, FILTER_SANITIZE_STRING);
   ...
   if($image_01_size > 2000000){
      ...
      $insert_property = $conn->prepare("INSERT INTO `property`(id, user_id, property_name, city, property_price, type, offer, status, furnished, bhk, deposite, bedroom, bathroom, balcony, area, age, floor, loan, lift, security_guard, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
      $insert_property->execute([$id, $user_id, $property_name, $city, $property_price, $type, $offer, $status, $furnished, $bhk, $deposite, $bedroom, $bathroom, $balcony, $area, $age, $floor, $loan, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="box">
            ...
            <input type="number" name="property_price" required min="0" max="9999999999" maxlength="10" placeholder="enter property price" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="text" name="city" required maxlength="100" placeholder="enter property city" class="input">
         </div>
         <div class="box">
