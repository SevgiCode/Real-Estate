...
if(isset($_POST['h_search'])){
   ...
   $select_properties = $conn->prepare("SELECT * FROM `property` WHERE city LIKE '%{$h_location}%' ORDER BY date DESC");
   ...
   $select_properties = $conn->prepare("SELECT * FROM `property` WHERE city LIKE '%{$location}%' AND type LIKE '%{$type}%' AND offer LIKE '%{$offer}%' AND bhk LIKE '%{$bhk}%' AND status LIKE '%{$status}%' AND furnished LIKE '%{$furnished}%' AND property_price BETWEEN $min AND $max ORDER BY date DESC");
   $select_properties->execute();
...
<section class="listings">
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price"><i class="fas fa-indian-rupee-sign"></i><span><?= $fetch_property['property_price']; ?></span></div>
