...
<section class="view-property">
   ...
   <?php
      $select_properties = $conn->prepare("SELECT * FROM `shop` WHERE id = ? ORDER BY date DESC LIMIT 1");
      ...
      if($select_properties->rowCount() > 0){
         ...
         $select_saved = $conn->prepare("SELECT * FROM `saved` WHERE id = ? and user_id = ?");
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <h3 class="name"><?= $fetch_property['shop_name']; ?></h3>
      <p class="location"><i class="fas fa-map-marker-alt"></i><span><?= $fetch_property['city']; ?></span></p>
      <div class="info">
         <p><i class="fas fa-euro-sign"></i><span><?= $fetch_property['shop_price']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>deposit amount : </i><span><span class="fas fa-euro-sign" style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
            <p><i>status :</i><span><?= $fetch_property['status']; ?></span></p>

         </div>
         <div class="box">
            <p><i>carpet area :</i><span><?= $fetch_property['area']; ?>sqft</span></p>
            <p><i>age :</i><span><?= $fetch_property['age']; ?> years</span></p>
            <p><i>total floors :</i><span><?= $fetch_property['floor']; ?></span></p>
   ...
   <?php
      ...
      echo '<p class="empty">shop not found! <a href="post_shop.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
   }
   ?>
